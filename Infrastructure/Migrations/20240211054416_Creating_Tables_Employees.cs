...
{
    /// <inheritdoc />
    public partial class Creating_Tables_Employees : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetNumber = table.Column<string>(type: "nvarchar(20)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAddress",
                table: "EmployeeAddresses",
                columns: new[] { "EmployeeId", "AddressId" },
                unique: true);
